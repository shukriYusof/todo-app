<template>
    <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 main-bg border-b flex items-center justify-between">
            ...
            <!-- dropdown menu -->
            <div class="absolute top-[70px] min-h-[130px] main-bg border  shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
                <a href="#" class="block px-4 py-2 hover:bg-gray-200">Account</a>
                <a href="#" class="block px-4 py-2 hover:bg-gray-200">Settings</a>
                <router-link to="/login" class="block px-4 py-2 hover:bg-gray-200">Logout</router-link>
            </div>
            <!-- dropdown menu end -->
